    ...
    function User({ user }) {
        return (
            <>
                ...
                <div className=' m-3 p-3 w-[200px] h-[260px]'>
                    <div className='flex justify-center'>

                        <img src={user.thumbnail} alt="image" style={{ height: "100px", width: "120px" }} />
    ...
    return (
        <>
            ...
            <div className="flex mx-[60px] my-[30px] flex-wrap">
                <div className=' h-[100%]'>
                    <p className='mt-2 font-bold text-2xl'>Top Pics for your oasis</p>
